...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void updatePos(int change) {
        ...
        if(mOnHeaderScrollListener != null) {
            mOnHeaderScrollListener.scrollChange(mHeaderHeight, mPtrIndicator.getCurrentPosY());
        }
    ...
    public ILoadViewMoreFactory loadViewFactory = new DefaultLoadMoreFooter();
    ...
    OnHeaderScrollListener mOnHeaderScrollListener;

    public void setOnHeaderScrollListener(OnHeaderScrollListener mOnHeaderScrollListener) {
        this.mOnHeaderScrollListener = mOnHeaderScrollListener;
    }

    public interface OnHeaderScrollListener{
        void scrollChange(int headerHeight, int currentPos);
    }
}
